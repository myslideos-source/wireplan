...
export function ExportsNotReady({ project }: { project: Project }) {
  return (
      ...
      <Card className="flex max-w-md flex-col items-center gap-4 px-8 py-10 text-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-text-secondary">
            Der PDF-Export liest Grundriss, Elektroplanung und Kabelliste aus
            dem Editor. Öffnen Sie das Projekt dort zuerst.
          </p>
        </div>
